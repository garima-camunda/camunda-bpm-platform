...
public class HistoricProcessInstanceAuthorizationTest extends AuthorizationTest {
  ...
  public void testCheckAllHistoricProcessInstancePermissions() {
    ...
    assertTrue(authorizationService.isUserAuthorized(userId, null,
        HistoricProcessInstancePermissions.NONE, Resources.HISTORIC_PROCESS_INSTANCE));

    assertTrue(authorizationService.isUserAuthorized(userId, null,
        HistoricProcessInstancePermissions.READ, Resources.HISTORIC_PROCESS_INSTANCE));

    assertTrue(authorizationService.isUserAuthorized(userId, null,
        HistoricProcessInstancePermissions.ALL, Resources.HISTORIC_PROCESS_INSTANCE));
  }
